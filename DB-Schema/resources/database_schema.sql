-- =====================================================
-- USER PANEL DATABASE SCHEMA - COMBINED REFERENCE FILE
-- Modular and Modifiable Design
-- =====================================================
-- 
-- ⚠️  NOTE: This is a COMBINED/REFERENCE version
-- 
-- For production use, prefer the modular structure in the /schema folder:
--   - schema/00_main_schema.sql (main entry point)
--   - schema/01_authentication.sql
--   - schema/02_products.sql
--   - ... etc
-- 
-- This file is kept for:
--   - Quick reference (see everything in one place)
--   - Backup/alternative installation method
--   - Documentation purposes
-- 
-- ⚠️  If you modify the schema, update BOTH:
--   1. The individual module files in /schema folder
--   2. This combined file
-- 
-- =====================================================
